...
if __name__ == "__main__":
    ...
    # Get reference output from Hugging Face if in test mode
    if args.test:
    ...
    print(f"Starting llaisys inference with max_steps={args.max_steps}")
    ...
    try:
        ...
        print(f"Error during llaisys inference: {e}")
        import traceback
